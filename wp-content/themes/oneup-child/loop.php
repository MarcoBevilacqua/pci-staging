...
<?php $isShow = 'spettacoli' == get_the_category()[0]->name; ?>
			...
			<div class="row-fluid">
				<div class="span12">
                    ...
                    <div class="text-center">
                        <?php if($isShow) : ?>
                            <?php $buy_link = get_permalink(get_field('prodotto_correlato')[0]); ?>
                            <a class="btn btn-danger" target="_blank" title="compra" href="<?php echo $buy_link; ?>"> Compra il tuo biglietto</a>
                        <?php endif; ?>
                    </div>
				</div>
			</div>
